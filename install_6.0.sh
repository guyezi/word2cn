...
if [ "$kernelStatus" = "" ]; then
	if [ "$huaweiLogin" != "" ] && [ "$huaweiSys" != "" ]; then
		##https://api.loli.host/src/kernel-headers-3.10.0-514.el7.x86_64.rpm
...
Install_setuptools()
{
	if [ ! -f "/usr/bin/easy_install" ];then
		#https://api.loli.host/install/src/setuptools-33.1.1.zip
...
Install_pip()
{
	...
	if [ "$ispip" == "" ];then
		...
		#https://api.loli.host/install/src/pip-9.0.1.tar.gz
...
Install_Pillow()
{
	...
	if [ "$isSetup" = "" ];then
		...
		#https://api.loli.host/install/src/Pillow-3.2.0.zip 
...
Install_psutil()
{
	...
	if [ "$isSetup" = "" ];then
		##https://api.loli.host/install/src/psutil-5.2.2.tar.gz
...
Install_mysqldb()
{
	...
	if [ "$isSetup" = "" ];then
		##https://api.loli.host/install/src/MySQL-python-1.2.5.zip
...
Install_chardet()
{
	...
	if [ "$isSetup" = "" ];then
		#https://api.loli.host/install/src/chardet-2.3.0.tar.gz
...
Install_webpy()
{
	...
	if [ "$isSetup" = "" ];then
		#https://api.loli.host/install/src/web.py-0.38.tar.gz
...
##https://api.loli.host/install/src/panel6.zip
wget -O panel.zip $download_Url/install/src/panel6.zip -T 10
##https://api.loli.host/install/src/bt6.init
...
#https://api.loli.host/install/acme_install.sh
...
#https://api.loli.host/btwaf.sh
wget $download_Url/btwaf.sh
#https://api.loli.host/total.sh
wget $download_Url/total.sh
